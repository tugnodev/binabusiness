...
{#if isOpen}
<div in:fly={{ x: -500 }} out:fly={{ x: -500 }} class="fixed z-30 top-0 p-4 left-0 flex flex-col justify-center shadow-lg items-center w-full md:w-96 h-full bg-base-200/60">
